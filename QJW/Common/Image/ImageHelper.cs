...
namespace QJW.Common
{
    ...
    public class ImageHelper
    {
        ...
        public static void GetPartOfImage(string bitmapPathAndName, int offsetX, int offsetY,string toImagePath, int width, int height)
        {
            ...
            resultBitmap.Save(toImagePath, ImageFormat.Png);
